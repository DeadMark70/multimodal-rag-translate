...
_ROUTE_BUDGETS: dict[AgenticV9Route, _RouteBudget] = {
    ...
    "multi_document_exact": _RouteBudget(2, 1, 4, 50_000),
    "multi_hop": _RouteBudget(2, 1, 4, 50_000),
...
class RoutePlanner:
    ...
    async def plan(
        ...
        *,
        ...
        del setup_policy  # Compatibility with the setup-authoritative campaign adapter.
