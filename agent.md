...
- 2026-08-14: Evaluation golden datasets are immutable regression oracles, not
  runtime ID allowlists. Agentic v9 preflight must admit every selected owned
  test case through the current admission-contract builder and keep only real
  ownership, source-scope, and budget feasibility failures as execution gates.
