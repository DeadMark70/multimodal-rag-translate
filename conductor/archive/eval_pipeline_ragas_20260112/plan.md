...
## Hotfix: Ragas & Rate Limit Fixes [checkpoint: 96e62eb]
- [x] Task: Fix Ragas metric initialization (pass embeddings, set llm) 96e62eb
- [x] Task: Update evaluator model to gemini-2.5-pro 96e62eb
- [x] Task: Restrict test models to gemini-2.0-flash-lite and gemini-2.5-flash-lite 96e62eb
