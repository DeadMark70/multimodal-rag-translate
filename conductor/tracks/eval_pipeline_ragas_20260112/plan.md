...
- [ ] Task: Implement dynamic model overriding for `get_llm` in `core/llm_factory.py` or within the pipeline
- [ ] Task: Implement Token Monitoring logic to capture `usage_metadata` from LangChain responses
